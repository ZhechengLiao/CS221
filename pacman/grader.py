...
grader.add_basic_part('4a-1-basic', lambda : testq4(), 0, max_seconds=max_seconds, description='betterEvaluationFunction test')
grader.add_manual_part('4b', 0, description='Description of your evaluation function.')
