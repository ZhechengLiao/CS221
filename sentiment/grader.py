...
grader.add_manual_part('4d', max_points=2, description='deploying classifier')
grader.add_manual_part('4e', max_points=2, description='data source')
############################################################
...
def test5b0():
    ...
    grader.require_is_true(isinstance(list(centers[0].values())[0], float) or isinstance(centers[0].values()[0], int))
...
grader.add_hidden_part('5b-3-hidden', test5b3, max_points=2, max_seconds=10, description="make sure the code runs fast enough")
